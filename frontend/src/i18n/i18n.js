  ...
  zh: {
    translation: {
      ...
      prediction: {
        ...
        forecastMode: "此結果為 AI 未來能源預測，僅供趨勢分析與研究參考。",
  ...
  en: {
    translation: {
      ...
      prediction: {
        ...
        apiError: "Unable to connect to AI prediction service.",
        historyMode: "Historical data is available for this year. Showing actual energy structure.",
        forecastMode: "This result is an AI forecast for reference and trend analysis.",
        multiYearTrend: "AI Multi-Year Energy Trend Analysis",
